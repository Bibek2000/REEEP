<div class="card-body">
    ...
    <div class="form-group">
        ...
        {!! Form::file('image', null, ['class'=>'form-control', 'placeholder'=>'Upload Image', 'id' => 'image']) !!}
        @error('image')<span class="text-danger">{{$message}}</span>@enderror
    </div>
    <div class="form-group">
        <div>
            <div class="col-md-12 mb-2">
                <embed id="preview-pdf-before-upload" src=""  style="width: 100%; height: 100px;">
            </div>
        </div>
        {!! Form::label('pdf', 'Upload PDF') !!}
        {!! Form::file('pdf', null, ['accept'=>'application/pdf', 'class'=>'form-control', 'placeholder'=>'Upload PDF', 'id' => 'pdf']) !!}
